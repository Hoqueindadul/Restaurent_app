import {
  ...
  Button_default2,
  useButtonProps
} from "./chunk-XCTNX6PL.js";
import {
  require_prop_types,
  require_warning
} from "./chunk-ORDIAK46.js";
import {
  require_classnames,
  useBootstrapPrefix,
  useIsRTL
...
function useUncontrolled(props, config) {
  return Object.keys(config).reduce(function(result, fieldName) {
    var _extends2;
    var _ref = result, defaultValue = _ref[defaultKey(fieldName)], propsValue = _ref[fieldName], rest = _objectWithoutPropertiesLoose4(_ref, [defaultKey(fieldName), fieldName].map(_toPropertyKey));
...
//# sourceMappingURL=chunk-UINADPAP.js.map
