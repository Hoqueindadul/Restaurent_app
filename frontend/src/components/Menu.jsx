                    ...
                    <div className="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
                        <ul className="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                            <li className="nav-item">
                                <a className="d-flex align-items-center text-start mx-3 ms-0 pb-3 active icon" data-bs-toggle="pill" href="#tab-1">
                                    <i className="fa fa-coffee fa-2x text-primary ico"></i>
                                    <div className="ps-3">
